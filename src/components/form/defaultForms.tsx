...
export const addressFormDefault: FormInput[] = [
    {
      ...
      defaultValue: '',
      validationRuleNames: [
        { type: ValidationRuleEnum.Required, args: 'Address' }
      ]
    }
];
...
export function GeneratePrefilledAddressForm(address: Address): FormInput[]{
    ...
    prefilledForm[0].name += " " + address.type.charAt(0).toUpperCase() 
...
export const creditCardFormDefault: FormInput[] = [
    {
      ...
      defaultValue: '',
      validationRuleNames: [{ type: ValidationRuleEnum.Required, args: 'Credit Card Number' },
    ...
    },
    {
      ...
      defaultValue: '',
      validationRuleNames: [
        { type: ValidationRuleEnum.Required, args: 'Expiry Date' }
      ]
    },
    {
      name: 'CVV',
      ...
      defaultValue: '',
      validationRuleNames: [
        { type: ValidationRuleEnum.Required, args: 'CVV' }
      ]
    },
    {
      ...
      defaultValue: '',
      validationRuleNames: [
        { type: ValidationRuleEnum.Required, args: 'Billing Address' }
      ]
    }
];
