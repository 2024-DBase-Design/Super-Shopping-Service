...
export class ValidationRule {
  ...
  constructor(formValues: FormValues, validationTest: (formValues: FormValues, value: any) => string) {
...
function RequiredClosure(fieldName: string = "this field"): (formValues: FormValues, value: any) => string{
...
export function getValidationTest(validationRule: ValidationRuleType): (formValues: FormValues, value: any) => string {
